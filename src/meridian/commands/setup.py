...
def run(
    ...
    *,
    ...
    server_name = server_name or DEFAULT_BRAND_NAME
    icon = icon or DEFAULT_SERVER_ICON
    color = color or DEFAULT_BRAND_COLOR
...
def _interactive_wizard(
    ...
    if not yes and not server_name:
        ...
        err_console.print()
        server_name = prompt("Server name", default=DEFAULT_BRAND_NAME)
