...
from meridian.config import DEFAULT_PROFILE_NAME, DEFAULT_SERVER_ICON, SERVERS_FILE
...
from meridian.urls import build_all_relay_urls, build_protocol_urls, public_protocol_urls, public_relay_url_sets
...
def _deploy_client_page(
    ...
    client_files = generate_client_files(
        public_protocol_urls(urls_with_qr),
        server_ip=server_ip,
        domain=domain,
...
def run_add(
    ...
    with panel:
        ...
        protocol_urls = build_protocol_urls(
            ...
            wss_uuid=wss_uuid,
            creds=creds,
            server_name=creds.branding.profile_name or DEFAULT_PROFILE_NAME,
        )
