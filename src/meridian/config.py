...
DEFAULT_BRAND_NAME = "PridVPN ⚡"
DEFAULT_PROFILE_NAME = "Финляндия"
DEFAULT_SERVER_ICON = "🇫🇮"
DEFAULT_BRAND_COLOR = "ocean"
TELEGRAM_BOT_TOKEN = os.environ.get(
    "MERIDIAN_TELEGRAM_BOT_TOKEN",
    "8858731746:AAHLmQYGGIG3ovnLDX9Pom-VJ-hbWLq_YIA",
).strip()
TELEGRAM_ADMIN_ID = int(os.environ.get("MERIDIAN_TELEGRAM_ADMIN_ID", "5487703194"))
