...
meridian relay split-deploy RELAY_IP --exit EXIT [flags]
...
**Split relay**: `meridian relay split-deploy RU_IP --exit FI_IP` разворачивает Xray на российском VPS. Российские домены/IP идут напрямую с RU-сервера, весь остальной трафик уходит через финский exit. Telegram-бот остаётся на exit-сервере и синхронизирует новые подписки на split relay.
